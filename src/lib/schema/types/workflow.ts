...
*/
    ...
    export interface Authdef {
        ...
        properties: string | /* Basic auth information */ Basicpropsdef | /* Bearer auth information */ Bearerpropsdef | /* OAuth2 information */ Oauth2propsdef;
    }
    /**
    ...
    export type Continueasdef = string | {
        /**
    ...
    export type Secrets = string /* uri */ | [
        string,
        ...string[]
    ];
    export type Sleep = {
    ...
    export type Switchstate = /* Permits transitions to other states based on data conditions */ Databasedswitchstate | /* Permits transitions to other states based on events */ Eventbasedswitchstate;
    export type Timeouts = string /* uri */ | {
        workflowExecTimeout?: WorkflowExecTimeout;
        stateExecTimeout?: StateExecTimeout;
        actionExecTimeout?: /* Single actions definition execution timeout duration (ISO 8601 duration format) */ ActionExecTimeout;
        branchExecTimeout?: /* Single branch execution timeout duration (ISO 8601 duration format) */ BranchExecTimeout;
    ...
    export type WorkflowExecTimeout = string | {
        /**
